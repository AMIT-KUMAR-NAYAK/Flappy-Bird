...
//bird
let birdWidth = 34; // W/H = 408/228 = 17/12
let birdHeight = 24;
...
let wingSound = new Audio("./Sounds/flappy_bird/flap.mp3");
let hitSound = new Audio("./Sounds/flappy_bird/hit.mp3");
let pointSound = new Audio("./Sounds/flappy_bird/point.mp3");
let dieSound = new Audio("./Sounds/flappy_bird/die.mp3");
let bgmSound = new Audio("./Sounds/flappy_bird/bgm.mp3");
bgmSound.loop = true;
...
window.onload = () => {
    ...
    // load Images
    // birdImg = new Image();
    // birdImg.src = "./Images/bird/flappybird.png"
    // birdImg.onload = ()=>{
    ...
    for(let i = 0; i < 4; i++)
    {
        ...
        birdImg.src = `./Images/bird/flappybird${i}.png`;
    ...
    setInterval(animateBird, 100); // every 0.1s second
...
function update()
{
    ...
    // birdImgsIndex++;
    // birdImgsIndex %= birdImgs.length; // circle back to first image
